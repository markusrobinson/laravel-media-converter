...
class DummyMessages
{
    protected array $headers = [
        'Host' => 'markusrobinson-api.test:443',
        ...
        'x-original-host' => 'markusrobinson-api.sharedwithexpose.com',
    ];
            ...
            'outputGroupDetails' => [
                ...
                [
                    'outputDetails' => [
                        [
                            'outputFilePaths' => [
                                's3://markusrobinson-stage/some/path/isI2oN3/hls/Raindrops_Videvo_1.m3u8',
                            ],
                            'durationInMs' => 58975,
                            'videoDetails' => [
                                'widthInPx' => 1920,
                        ...
                        [
                            'outputFilePaths' => [
                                's3://markusrobinson-stage/some/path/isI2oN3/hls/Raindrops_Videvo_2.m3u8',
                            ],
                            'durationInMs' => 58975,
                            'videoDetails' => [
                                'widthInPx' => 1920,
                        ...
                        [
                            'outputFilePaths' => [
                                's3://markusrobinson-stage/some/path/isI2oN3/hls/Raindrops_Videvo_3.m3u8',
                            ],
                            'durationInMs' => 58975,
                            'videoDetails' => [
                                'widthInPx' => 1280,
                        ...
                        [
                            'outputFilePaths' => [
                                's3://markusrobinson-stage/some/path/isI2oN3/hls/Raindrops_Videvo_4.m3u8',
                            ],
                            'durationInMs' => 58975,
                            'videoDetails' => [
                                'widthInPx' => 960,
                        ...
                        [
                            'outputFilePaths' => [
                                's3://markusrobinson-stage/some/path/isI2oN3/hls/Raindrops_Videvo_5.m3u8',
                            ],
                            'durationInMs' => 58975,
                            'videoDetails' => [
                                'widthInPx' => 768,
                        ...
                        [
                            'outputFilePaths' => [
                                's3://markusrobinson-stage/some/path/isI2oN3/hls/Raindrops_Videvo_6.m3u8',
                            ],
                            'durationInMs' => 58975,
                            'videoDetails' => [
                                'widthInPx' => 640,
                    ...
                    'playlistFilePaths' => [
                        's3://markusrobinson-stage/some/path/isI2oN3/hls/Raindrops_Videvo.m3u8',
                    ],
                    'type' => 'HLS_GROUP',
                ],
                [
                    'outputDetails' => [
                        [
                            'outputFilePaths' => [
                                's3://markusrobinson-stage/some/path/isI2oN3/mp4/Raindrops_Videvo.mp4',
                            ],
                            'durationInMs' => 58975,
                            'videoDetails' => [
                                'widthInPx' => 1920,
    ...
    protected array $inputInformation = [
        ...
        'detail' => [
            ...
            'inputDetails' => [
                [
                    'id' => 1,
                    'uri' => 's3://markusrobinson-stage/some/path/isI2oN3/Raindrops_Videvo.mp4',
                    'video' => [
                        [
                            'bitDepth' => 8,
                            'codec' => 'H_264',
    ...
    protected array $error = [
        ...
        'detail' => [
            ...
            'status' => 'ERROR',
            'errorCode' => 1404,
            'errorMessage' => 'Unable to open input file [s3://markusrobinson-stage/some/path/AoTef8Z/Raindrops_Videvo.mp4]: [Failed probe/open: [Failed to read data: HeadObject failed]]',
            'userMetadata' => [
                'model_id' => '23',
                'hello' => 'world',
            ],
