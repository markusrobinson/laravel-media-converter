...
![laravel-media-converter package image](https://banners.beyondco.de/Media%20Converter.png?theme=light&packageManager=composer+require&packageName=markusrobinson%2Flaravel-media-converter&pattern=floatingCogs&style=style_1&description=Easily+%26+quickly+integrate+your+application+with+AWS+MediaConvert.&md=1&showWatermark=1&fontSize=125px&images=video-camera&widths=350)

## 💡 Usage

``` php
use markusrobinson\MediaConverter\Facades\MediaConvert;
use markusrobinson\MediaConverter\Jobs\CreateVideoConversion;
...
```bash
composer require markusrobinson/laravel-media-converter
```
...
```bash
php artisan vendor:publish --provider="markusrobinson\MediaConverter\Providers\MediaConverterServiceProvider" --tag="config"
```
...
use markusrobinson\MediaConverter\Traits\Convertable;
...
For example,
```
https://markusrobinson-api.sharedwithexpose.com/api/webhooks/media-converter
```
...
Please see our [releases](https://github.com/markusrobinsonlabs/laravel-media-converter/releases) page for more information on what has changed recently.
...
[Media Converter on GitHub](https://github.com/markusrobinsonlabs/laravel-media-converter/discussions)

For casual chit-chat with others using this package:

[Join the markusrobinson Discord Server](https://discord.markusrobinson.io)

## 🚨 Security

Please review [our security policy](https://github.com/markusrobinsonlabs/laravel-media-converter/security/policy) on how to report security vulnerabilities.

## 🙏🏼 Credits

- [Chris Breuer](https://github.com/Chris1904)
- [Folks at markusrobinson](https://github.com/markusrobinsonlabs)
...
Made with ❤️ by markusrobinson, Inc.
